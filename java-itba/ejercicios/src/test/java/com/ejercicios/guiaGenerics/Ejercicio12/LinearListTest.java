...
public class LinearListTest {
  ...
  public void linearList() {
    LinearList list = new LinearListImplementation(5);
    ...
    assertEquals(list.get(0), o2);
    assertEquals(list.indexOf(o2), 0);
    assertEquals(list.get(1), o4);
    assertEquals(list.indexOf(o4), 1);
    assertEquals(list.get(2), o3);
    assertEquals(list.indexOf(o3), 2);
    assertEquals(list.get(3), o1);
    assertEquals(list.indexOf(o1), 3);
    assertEquals(list.get(4), null);
    assertEquals(list.size(), 4);
    list.add(o5);
    assertEquals(list.size(), 5);
    assertEquals(list.get(4), o5);
    assertEquals(list.indexOf(o5), 4);
